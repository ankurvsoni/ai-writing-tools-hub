    ...
    if (t.startsWith('# ')) {
      ...
      if (currentSection.includes('top picks')) {
        ...
        if (m) {
          ...
          out.push(`<li><div class="pickMedia"><img class="pickThumb" src="${thumb}" alt="Product image" loading="lazy" onload="this.parentElement.classList.add('loaded')" onerror="this.parentElement.remove()"/></div>${itemHtml}</li>`);
        } else {
